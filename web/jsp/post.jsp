...
<div class="main">
    <section class="post">
        <div>
            <img src="${pageContext.request.contextPath}/img/1.jpg" alt="头像" title="头像">
        </div>
        <div>
            <div>
                （内容）：${post.content}
    ...
    <section class="comments">
        <img class="loading" src="${pageContext.request.contextPath}/img/3.jpg">
    </section>
        ...
        xhr.onload = function (e) {
            if (this.status === 200) {
                ...
                for (var i = 0; i < comments.length; i++) {
                    ...
                    result += "<header>" +
                        "<span>" + " 作者：" +comments[i].author + "</span>" +
                        "<i class='del' onclick='doDelComment(" + comments[i].id + ")'>删除</i></header>";
                    result += "<p>" + "内容：" + comments[i].content + "</p>";
                    result += "<span>" + "时间：" + comments[i].created + "</span>"
                    result += "</div>";
                }
